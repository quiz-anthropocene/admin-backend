...
COMMENT_TYPE_EDITABLE_LIST = [
    COMMENT_TYPE_COMMENT_QUESTION,
    COMMENT_TYPE_COMMENT_QUIZ,
    COMMENT_TYPE_COMMENT_CONTRIBUTOR,
    COMMENT_TYPE_REPLY,
]
