...
class QuestionFilter(django_filters.FilterSet):
    ...
    difficulty = django_filters.MultipleChoiceFilter(label="Niveau(x) de difficulté de la question", choices=constants.QUESTION_DIFFICULTY_CHOICES)
    language = django_filters.MultipleChoiceFilter(label="Langue(s) de la question", choices=constants.LANGUAGE_CHOICES)
