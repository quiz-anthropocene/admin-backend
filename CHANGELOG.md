...
## [2.7.0](https://github.com/quiz-anthropocene/admin-backend/compare/v2.6.0...v2.7.0) (2026-04-23)
...
* **Questions:** Admin: new readonly list of all the last changes ([#2039](https://github.com/quiz-anthropocene/admin-backend/issues/2039)) ([419150d](https://github.com/quiz-anthropocene/admin-backend/commit/419150d6f4aa196bfed72a4b5862495e446f52a6))
...
* **Admin:** fieldsets_with_inlines: override template for compatibility with Django 5 (length_is, CSS) ([#2040](https://github.com/quiz-anthropocene/admin-backend/issues/2040)) ([81bbe46](https://github.com/quiz-anthropocene/admin-backend/commit/81bbe46cf35eb27852ad233bcc7b9a80ab886ec2))
...
* **Questions:** Admin: add report_skipped. Display updated column. ref [#2043](https://github.com/quiz-anthropocene/admin-backend/issues/2043) ([08c6c43](https://github.com/quiz-anthropocene/admin-backend/commit/08c6c43e3fc35f2427598af2bf3eec40ec91d50d))
* **Questions:** Admin: fix import errors (format, ID) ([#2042](https://github.com/quiz-anthropocene/admin-backend/issues/2042)) ([cb0aac1](https://github.com/quiz-anthropocene/admin-backend/commit/cb0aac100305aef07470fa7afa7d81da2fab2136))
* **Questions:** Admin: more improvements (fill author, allow XLS & ODS, boolean true values) ([#2044](https://github.com/quiz-anthropocene/admin-backend/issues/2044)) ([c394057](https://github.com/quiz-anthropocene/admin-backend/commit/c394057acc66e369a6e9baeeb248d24db96da427))
* **Questions:** Admin: remove notion stuff post import. should fix import in prod. ref [#2043](https://github.com/quiz-anthropocene/admin-backend/issues/2043) ([515d943](https://github.com/quiz-anthropocene/admin-backend/commit/515d94320a4d3caa6085481e8f984b4a6c56e8dc))
